 ...
 * If you need to perform changes, edit the VilleBean class instead!
 */

/**
 * The VilleBaseBean class maps the 'ville' table in database.
 * @dbTable ville
 */
class VilleBaseBean extends TDBMObject
{
	/**
	...
	/**
	 * The getter for the "nom_ville" column.
	 *
	 * @dbType string
	 * @dbColumn nom_ville
	 * @return string
	...
	public function getNomVille(){
		return $this->__get('nom_ville');
	}
	
	/**
	 * The setter for the "nom_ville" column.
	 *
	 * @dbColumn nom_ville
	 * @param string $nom_ville
	 */
	public function setNomVille($nom_ville) {
		$this->__set('nom_ville', $nom_ville);
	}
