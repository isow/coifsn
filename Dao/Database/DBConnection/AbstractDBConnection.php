 ...
 *
 */
abstract class AbstractDBConnection implements ConnectionSettingsInterface, ConnectionInterface {
	 ...
	 *
	 * @see ConnectionInterface::toStandardcase()
	 ...
	 */
	//abstract public function createTable(Table $table, $dropIfExist);
